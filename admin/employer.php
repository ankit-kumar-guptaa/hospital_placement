...
<head>
    ...
    <title>Employer Submissions - Admin Dashboard</title>
...
<body class="dark-mode">
        ...
        <div class="row g-0">
            ...
            <div class="col-md-2 sidebar p-4">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="employer.php"><i class="fas fa-building"></i> Employer Submissions</a></li>
            ...
            <div class="col-md-10 content">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4><i class="fas fa-building icon"></i> Employer Form Submissions</h4>
                    </div>
                    <div class="card-body">
                        <input type="text" id="employerSearch" class="form-control search-box" placeholder="Search...">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="fromDateEmployer">From Date:</label>
                                <input type="date" id="fromDateEmployer" class="form-control">
                            </div>
                            <div class="col-md-6">
                                <label for="toDateEmployer">To Date:</label>
                                <input type="date" id="toDateEmployer" class="form-control">
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#fromDateEmployer, #toDateEmployer").on("change", function() {
                var fromDate = $("#fromDateEmployer").val();
                var toDate = $("#toDateEmployer").val();
                $("#employerTable tbody tr").each(function() {
