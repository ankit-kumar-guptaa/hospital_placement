...
<body class="dark-mode">
        ...
        <div class="row g-0">
            ...
            <div class="col-md-2 sidebar p-4">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="contact.php"><i class="fas fa-envelope"></i> Contact Submissions</a></li>
            ...
            <div class="col-md-10 content">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4><i class="fas fa-envelope icon"></i> Contact Form Submissions</h4>
                    </div>
                    <div class="card-body">
                        <input type="text" id="contactSearch" class="form-control search-box" placeholder="Search...">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="fromDateContact">From Date:</label>
                                <input type="date" id="fromDateContact" class="form-control">
                            </div>
                            <div class="col-md-6">
                                <label for="toDateContact">To Date:</label>
                                <input type="date" id="toDateContact" class="form-control">
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#fromDateContact, #toDateContact").on("change", function() {
                var fromDate = $("#fromDateContact").val();
                var toDate = $("#toDateContact").val();
