...
<div class="slider-container">
    <div class="heading1">Specialized Medical Recruitment Team since 2010 <div class="small1">
            Let us know what are you looking for </div>
    </div>
...
<style>
    ...
    * {
    ...
    .slider-container {
        display: flex;
        flex-wrap: wrap;
        background: linear-gradient(135deg, #42a5f5, #262728);
