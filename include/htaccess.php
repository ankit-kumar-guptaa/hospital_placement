...
function hp_htaccess_base($errorDocs = array())
{
    ...
    $o[] = '<FilesMatch "^(db|pages|markets|market-page|market-nav|seo|media|htaccess|assets|header|footer|page-hero|page-faq|topbar|forms|statbar|specializations|process|solution|service|counter|testimonial|why-choose|ensure|faq|cta|slider|skeleton-loader|cookie-consent)\.php$">';
