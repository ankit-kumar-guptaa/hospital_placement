...
foreach ($hp_hospitals as $s) {
  $hp_hospital_files[] = $s[0];
}
$hp_candidate_files = array();
foreach ($hp_candidates as $s) {
  $hp_candidate_files[] = $s[0];
}
  ...
  <div class="hp-wrap hp-header__bar">
    ...
    <a class="hp-logo" href="<?php echo hp_url(); ?>" aria-label="HospitalPlacement.com home">
      <img src="https://hosptal.hospitalplacement.com/wp-content/uploads/2021/05/logo-220.jpg"
        alt="HospitalPlacement.com, global healthcare recruitment agency" width="119" height="52">
    </a>
    ...
    <nav class="hp-nav" aria-label="Primary">
      <ul class="hp-nav__list">
        ...
        <li class="hp-nav__item hp-nav__item--has-mega">
          ...
          <div class="hp-mega">
            ...
            <div class="hp-mega__foot">
              ...
              <a class="hp-link" href="<?php echo hp_url('contact.php'); ?>">Post a Requirement <i
        ...
        <li class="hp-nav__item hp-nav__item--has-mega">
          ...
          <div class="hp-mega">
            ...
            <div class="hp-mega__foot">
              ...
              <a class="hp-link" href="<?php echo hp_url(); ?>#find-a-job">Register your CV <i
                  class="fa-solid fa-arrow-right" aria-hidden="true"></i></a>
            </div>
          </div>
        </li>
        ...
        <li class="hp-nav__item">
          <a class="hp-nav__link<?php echo $hp_blog ? ' is-active' : ''; ?>" href="/blog/">Blog</a>
        </li>
    ...
    <div class="hp-header__cta">
      ...
      <a class="hp-btn hp-btn--action hp-btn--sm" href="/#hire" data-modal-open="hp-formmodal"
        data-modal-tab="hp-tab-employer">Post a Requirement</a>

      <button type="button" class="hp-burger" aria-expanded="false" aria-controls="hp-drawer" aria-label="Open menu">
...
<div class="hp-drawer" id="hp-drawer">
  <ul class="hp-drawer__list">
    <li><a class="hp-drawer__link<?php echo (!$hp_blog && $hp_self === 'index.php') ? ' is-active' : ''; ?>"
        href="<?php echo hp_url(); ?>">Home</a></li>
    <li><a class="hp-drawer__link<?php echo hp_is('about.php') ? ' is-active' : ''; ?>"
        href="<?php echo hp_url('about.php'); ?>">About Us</a></li>

    <li>
      <button type="button" class="hp-drawer__link" aria-expanded="false">
        For Hospitals <i class="fa-solid fa-chevron-down" aria-hidden="true"></i>
      </button>
      <div class="hp-drawer__sub">
        <div>
          <?php foreach ($hp_hospitals as $s): ?>
    ...
    <li><a class="hp-drawer__link<?php echo hp_is('jobs.php') ? ' is-active' : ''; ?>"
        href="<?php echo hp_url('jobs.php'); ?>">Jobs</a></li>
    <li><a class="hp-drawer__link<?php echo $hp_blog ? ' is-active' : ''; ?>" href="/blog/">Blog</a></li>
    <li><a class="hp-drawer__link<?php echo hp_is('contact.php') ? ' is-active' : ''; ?>"
        href="<?php echo hp_url('contact.php'); ?>">Contact Us</a></li>
  </ul>

  <div class="hp-drawer__foot">
    <a class="hp-btn hp-btn--action hp-btn--block" href="/#hire" data-modal-open="hp-formmodal"
      data-modal-tab="hp-tab-employer">Post a Requirement</a>
